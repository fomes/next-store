...
export function ProductCard({ photo, name, price, desc }: ProductCardProps) {
  return (
    <div className="bg-[#fff] rounded-lg w-56 h-[17rem] relative">
      <div className="m-4">
        <div className="flex justify-center">
          <Image src={photo} alt="Product" height={120} width={120} />
        </div>

        <div className="flex items-center">
          <h1 className="text-[#2C2C2C] text-base font-normal">{name}</h1>
